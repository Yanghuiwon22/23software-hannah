...
@app.route("/")
def first_page():
    return "<a href='/'>첫페이지</a> <a href='/hello'>Hello!</a> <a href='/gugu/<int:dan>'>구구단</a><p>첫페이지 입니다!</p>"

@app.route("/hello")
def hello_world():
    return "<a href='/'>첫페이지</a> <a href='/hello'>Hello!</a> <a href='/gugu/<int:dan>'>구구단</a><p>Hello world!</p>"
